...
import { usePDF, Document, Page, PDFDownloadLink, BlobProvider, pdf } from '@react-pdf/renderer'
...
function DashboardPage() {
  ...
  //     a.href = instance.url
  //     a.download = `${new moment().format('DD-MM-YYYY')}-FailureReport.pdf`
  ...
  return (
    <div>
      ...
      <div className="flex flex-row gap-2">
        <div className={`flex md:flex-col gap-2 basis-full`}>
